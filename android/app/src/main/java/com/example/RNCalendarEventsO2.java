...
//                attendeeValues.put(CalendarContract.AttendeesColumns.ATTENDEE_EMAIL, attendee.getString("url"));
...
//                    android.util.Log.d("firstName", attendee.getString("firstName"));
                    attendeeValues.put(CalendarContract.Attendees.ATTENDEE_NAME, attendee.getString("firstName"));
//                    attendeeValues.put(CalendarContract.AttendeesColumns.ATTENDEE_NAME, attendee.getString("firstName"));
                }
